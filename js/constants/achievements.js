const ACH_DATA = {
	...
	descs: {
		...
		21: "Go at least boolean(extreme,thirty,thirty) km.",
		22: "Reach Rankboolean(extreme, six, seven).",
		...
		32: "Reach Rank showNum(13)",
		33: "Reach Tier showNum(4) and Reach Rank 32",
		...
		74: "Reachboolean(NG--, 1e47, 1e60) Rockets.",
		...
		85: "Reach boolean(NG--, 1e170, 1.79e308) intelligence.",
	...
	rewards: {
		...
		21: "Maximum Velocity is showNum(10)% higher and you get one extra Rank Cheapener for every Tier and Rank Cheapeners are +0.15x stronger for each achievement gottenboolean(extreme, and you get one extra Rank Cheapener for every Tier).",
		22: "Acceleration is showNum(33.33)% higherboolean(NG--,and you get one extra Rank Cheapener for every Tier Cheapener)boolean(extreme, and you start with one Rank Cheapener on Tier reset)",
	    ...
	    28: "boolean(NG--,Amoeba gain is better.)",
		...
		45: "You get one extra Rank Cheapener for every Rocket Fuel",
		...
		61: "Maximum Velocity is showNum(60)% higherboolean(extreme+hikers_dream, and divide energy loss by time cube upgrades (minimum 1))boolean(NG--, and you can buy Max Amoeba upgrades).",
		62: "boolean(NG--,Unlock new row of Time Reversal Upgrades.)",
		...
		74: "The 'Time Doesnt Exist' reward is showNum(75)% strongerboolean(NG--, and Time Speed affects Amoeba gain more).",
		75: "Dark Flow is showNum(10)% faster.",
		76: "Rocket gain is increased by showNum(2)%",
		77: "boolean(extreme+hikers_dream,Increase the base motivation softcap based on rockets.)boolean(NG--,Dark Core also affects Amoeba Upgrade Power.)",

		81: "Keep automation stuff on Infinityboolean(NG--, and keep Tier Cheapeners on pre Infinity resets).",
		82: "boolean(NG--,Knowledge boosts Maximum Velocity and Amoeba.)",
		83: "Dark Flow is showNum(20)% faster.",
		84: "Dark Flow affects Pathogen gain, slows down after showNum(50)x.",
		85: "boolean(NG--,Remove Maximum Velocity softcap.)boolean(hard+hikers_dream,You can rejuvinate whenever)boolean(extreme+hikers_dream, and square Endurance)boolean(hard+hikers_dream,.)",
