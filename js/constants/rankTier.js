...
const RANK_DESCS = {
	...
	2: "increase the acceleration and maximum velocity by 10% for each rank up (softcapped at 1e10).",
	3: "double your acceleration.",
	4: "triple your acceleration & maximum velocity for each tier up.",
	5: "increase the acceleration and maximum velocity by 15% for each rank up (softcapped at 1e10)",
	8: "increase your maximum velocity by 10% for each rank up (capped at 1e10).",
	9: "Rank rewards 3, 6 and 9 are stronger based on rank (capped at by 50%).",	
	15: "quadruple your acceleration.",
	25: "multiply your acceleration by 10.",
    28: "double intelligence gain.",
	30: "triple intelligence gain.",
	35: "time goes by 50% faster.",
	36: "multiply your acceleration & maximum velocity by (n+1)^1.6, where n is your rocket fuel.",
	...
	79: "remove softcap from Rank rewards 3, 6 and Rank reward 9 is uncapped.",
...
const TIER_DESCS = {
	...
	4: "time goes by 15% faster for each tier up.",
	5: "Multiply your maximum velocity by 32.",
