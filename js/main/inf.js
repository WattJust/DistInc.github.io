...
function calcKnowledgeGain(){
	...
	if (player.tr.upgrades.includes(51) && !HCCBA("noTRU")) tmp.inf.knowledgeGain = tmp.inf.knowledgeGain.times(player.amoebas.amount.plus(1).pow(0.01).logBase(10).pow(2).max(1))
